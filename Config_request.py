...
# Set of all features related to Germany(trafficsigns may vary deneding on country)
full_feature_set = {
    "trafficsigns" : ["regulatory--bicycles-only--g1","regulatory--dual-path-bicycles-and-pedestrians--g1", "regulatory--dual-path-pedestrians-and-bicycles--g1", "regulatory--end-of-dual-path-bicycles-and-pedestrians--g1", "regulatory--end-of-dual-path-pedestrians-and-bicycles--g1", "regulatory--end-of-maximum-speed-limit-10--g1", "regulatory--end-of-maximum-speed-limit-100--g",
...
# Create you own feature set here, keep the structure
custom_feature_set = {
    "trafficsigns" : [ 
